...
export const HeroPage = () => {
  ...
  return (
    <>
      ...
      >
        <img className="w-full h-full rounded-1-2xl" src={getHeroes.imagen} />
        <div className="px-6 py-4">
          ...
          <button onClick={onNavigationBack} className="w-full bg-indigo-500 px-8 py-2 mt-8 mb-6 rounded-lg uppercase font-bold hover:bg-indigo-700">👈 Regresar</button>
        </div>
      </div>
    </>
  );
